...
"""
/***************************************************************************
 DissectAndDissolveOverlapsSAGANextGen
                                 A QGIS plugin
...
__date__ = '2024-12-04'
__copyright__ = '(C) 2024 by Antonio Sobral Almeida'
...
class DissectAndDissolveOverlapsAlgorithm(QgsProcessingAlgorithm):
    ...
    OPTIONS = 'OPTIONS'
    option_list = ['Dissect and Dissolve overlaps', 'Dissect overlaps','Select and zoom to overlaps']
...
# *************************************************   Section3: Dissolve overlaps   **************************************************************
    ...
    def displayName(self):
        return 'Dissect/dissolve overlaps SAGA NextGen 0.1'
